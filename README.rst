...
As stated, the ODE that determines the source/reaction term is solved using CellML. The ODE model is input via `visualise.cmgui <./src/fortran/zero-rate.xml>`_.
