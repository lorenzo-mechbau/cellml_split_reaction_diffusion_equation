...
As stated, the ODE that determines the source/reaction term is solved using CellML. The ODE model is input via `constant_rate.xml <./src/fortran/constant_rate.xml>`_.
